...
public class Graph {
	...
	// gain is used only when you use it
	// the graph class is a loop or a forward path to calculate delta transfer function
	...
	/**
	 * in order to create graph easily, just add all nodes first and then call this
	 * function to generate all edges
	 */
	// fill the array of edges with the current node edges
	...
	/**
	 * check if this graph touches graph g in there words , they have common nodes
	 * 
	 * @param g
	 *            graph to check if it touches this graph
	 * @return true if both graph touch each other else it returns false
	 */
